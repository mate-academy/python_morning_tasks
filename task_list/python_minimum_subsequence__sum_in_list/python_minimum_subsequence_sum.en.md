Given a list `nums`, obtain a subsequence of the list whose sum of elements is **strictly greater** than the sum of the non included elements in such subsequence. 
